<header>
    <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
        <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            ...
            @auth
            <div class="flex items-center lg:order-2">
                <button class="bg-red-500 p-2 rounded-lg text-white font-bold hover:bg-slate-600 transition-all duration-500 flex items-center gap-2" wire:click='logout'>
                    <svg width="20px" fill="#fff" height="20px" viewBox="0 0 1 1" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><path width="16" height="16" id="icon-bound" fill="none" d="M0 0H1V1H0V0z"/><path d="M0.875 0.875V0.125H0.5V0h0.5v1H0.5v-0.125zm-0.563 -0.062L0 0.5l0.313 -0.313 0.088 0.088L0.239 0.438H0.75v0.125H0.239l0.162 0.162z"/></svg>
            ...
            <div class="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                    ...
                    <li>
                        <a href="{{$item['link']}}"
                        wire:navigate
                        @class(['text-black', 'text-blue-500' => Route::is($item['slugName'])])
